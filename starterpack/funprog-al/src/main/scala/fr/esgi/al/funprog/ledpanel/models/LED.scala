...
//ici on represente une couleur LED avec les composantes RGB (0 ou 1 chacune)
...
case class LED(x: Int, y: Int, color: Color = Color.BLACK, intensity: Double = 0.0) {
  ...
  //ici on change la couleur que si la lED est éteinte
